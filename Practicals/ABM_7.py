...
import agentframework_7_7
import csv

# set random seed for reproducible results
random.seed = 5

#a = agentframework_7.Agent()
#print(type(a))
#print(isinstance(a, agentframework_7.Agent))
#a.hi()
...
"""
# define distance function (pre-agentframework_7 version)
...
"""
# initial code for calling csv read function from agentframework_7
environment_file = 'in.txt' #'test.txt'
agentframework_7.create_env(environment_file)
"""
...
for i in range(num_of_agents):
    ...
    #agents.append(agentframework_7.Agent())
    name = ("Agent " + str(i)) # creating iterating agent name within name variable
    agents.append(agentframework_7.Agent(environment, name, agents)) # passing environment and name variables back into Agent class (making available to inner class functions)

# creating predators
for i in range(num_of_predators):
    name = ("Predator" + str(i))
    predators.append(agentframework_7.Predator(environment, name, agents, predators))
...
for agent in agents:
    #print("xy: " + str(agent.x) + "," + str(agent.y) + " store = " + str(agent.store)) alternate way of presenting name and location info (now inside agentframework_7)
